---
title: "Topology-based pathway analysis of microarray and RNA-seq data"
author:
    - name: Ivana Ihnatova
...
```{r clipper}
cli<-clipper(assay(airSE), group, pathways,type="RNASeq", method="mean")
res(cli)$results[[1]]
```
...
```{r PRS}
Prs<-PRS( assay(airSE), group, pwys, type="RNASeq",  logFC.th=-1, nperm=10)
res(Prs)
```
